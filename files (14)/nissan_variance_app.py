"""
Nissan Variance Analysis Tool  —  v3.3  (Light UI)
Changes vs v3.2:
  • Light theme — white cards on a soft grey page, Nissan red kept as the
    single accent colour.  Easier on the eyes for long FP&A sessions.
  • Tidier arrangement — consistent padding, lighter hairline borders,
    cleaner header.
  • Master MTD/YTD sheets are now actually hidden by the engine (v6.1).
"""
...
class NissanVarianceApp(tk.Tk):
    ...
    def _build_statusbar(self):
        ...
        tk.Label(bar, text="v3.3  -  Nissan FP&A",
