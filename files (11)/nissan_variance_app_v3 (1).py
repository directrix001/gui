"""
Nissan Variance Analysis Tool  —  v3.2
Changes vs v3.1:
  • Input Folders: single Browse button — opens dialog, adds folder,
    and immediately scans files (no separate Add / Scan buttons)
  • Financial Period: Quarter and Month merged into one combined
    dropdown  (e.g. "Q1 — April", "Q1 — May" …)
"""
