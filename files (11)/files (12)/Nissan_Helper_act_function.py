...
def paste_values_KPI_PL(original_file_path, sheet_names, cell_updates_list, month_name,output_path):
    ...
    reusult=output_path+"\\"+f'NEW_KPI_P&L_{month_name}_output_FY{current_year}.xlsx'
    print(reusult)
 
    new_file_path = os.path.join(os.getcwd(), 'New KPI Files', f'NEW_KPI_P&L_{month_name}_output_FY{current_year}.xlsx')
    new_file_path_1 = os.path.join(os.getcwd(), 'Mandatory_folder', f'NEW_KPI_P&L_{month_name}_output_FY{current_year}.xlsx')
...
def paste_values_goodwill(original_file_path, sheet_names, cell_updates_list, month_name,output_path):
    ...
    # file_name=f"Goodwill_{month_str}_output.xlsx"
